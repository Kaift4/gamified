...
export default function QuizPage() {
  ...
  return (
    <div className="flex h-screen flex-col md:flex-row relative">
      ...
      {/* Main Content */}
      <div className="flex flex-col items-center justify-center flex-grow bg-gray-900 min-h-screen p-6 md:p-12 text-center">
        ...
        <div className="mt-4 z-40 border-2 border-gray-600 w-full md:w-[calc(50%+1rem)] max-w-md bg-[#0F172A] rounded-xl px-4 py-3 flex items-center justify-center">
          <p className="text-white text-center text-sm">
            If faced with an error during content generation, please re-enter
            your API key using the <strong>Reset API Key</strong> button.
          </p>
        </div>
      </div>

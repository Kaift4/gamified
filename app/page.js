...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen relative">
      ...
      {/* Welcome Message */}
      <h1 className="text-3xl font-bold mb-4">Welcome to Gamified! 🎯</h1>
      ...
      <div className="mt-4 z-40 border-2 border-gray-600 w-[90%] max-w-md bg-[#0F172A] rounded-xl px-4 py-3 flex items-center justify-center">
        <p className="text-white text-center text-sm">
          Welcome to <strong>Gamified</strong>, folks! Before proceeding, please
          visit{" "}
          <a
          ...
          and copy your personal API key.
        </p>
      </div>
